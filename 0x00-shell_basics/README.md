...
Exercise 19: 0 string SCHOOL School data !:mime School Create a magic file called school.mgc that can be used with the command file to detect Holberton data files. School data files always contain "SCHOOL" at offset 0.
